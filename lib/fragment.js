...
module.exports = class Fragment extends EventEmitter {
    ...
    onResponse (response, isFallback) {
        ...
        // insertStart + responseStream + insertEnd => this.stream
        // and this.stream is returned by this.fetch()
        //
        // contentLengthStream is just a pass through stream but it calls a
        // callback function with content length.
        responseStream
